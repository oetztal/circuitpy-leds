...
class Christmas:
    ...
    def __init__(self, merry_go_round: int = 3, chunk_blendover: int = 5, whole_blendover: int = 5, velocity: int = 5):
        self.merry_go_round = merry_go_round
        self.chunk_blendover = chunk_blendover
        self.whole_blendover = whole_blendover
